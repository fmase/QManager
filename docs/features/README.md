...
| APN Management | `cellular/apn.sh` (actions: save/activate/clear) | `use-wan-profiles.ts` (`saveProfile`, `activateProfile`, `clearProfile`) | `wan-profiles.ts` (`WanProfile`, `CidContext`, `WanProfilesResponse`) | No |
